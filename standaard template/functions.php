...
function reserveringen() {
    ...
    ?> <table class = "table table-hover"><thead>
            <tr>
                <th>Reservering</th>
                <th class="reservering hidden-xs">Naam</th>
                <th class="reservering hidden-xs">Achternaam</th>
                <th class="reservering hidden-xs">Van</th>
                <th class="reservering hidden-xs">Tot</th>
                <th class="reservering hidden-xs">Pistolen</th>
                <th class="reservering">Status</th>
                <th> </th>
            </tr>
        </thead> <?php
    ...
    foreach ($reserveringen as $reservering) {
        print("<tr class=\"active\">");
        print("<td class=\"\">" . $reservering["reserveringnr"] . "</td>");
        print("<td class=\"reservering hidden-xs\">" . $reservering["naam"] . "</td>");
        print("<td class=\"reservering hidden-xs\">" . $reservering["achternaam"] . "</td>");
        ...
        print("<td class=\"reservering hidden-xs\">" . $vandatum . "</td>");
        print("<td class=\"reservering hidden-xs\">" . $totdatum . "</td>");
        print("<td class=\"reservering hidden-xs\">" . $reservering["aantal_pistolen"] . "</td>");
        
        if ($reservering["status"] == 1) {
            $reservering["status"] = "<span class=\"label label-warning\">In beoordeling</span>";
        } elseif ($reservering["status"] == 2) {
            $reservering["status"] = "<span class=\"label label-primary\">In behandeling</span>";
        } elseif ($reservering["status"] == 3) {
            $reservering["status"] = "<span class=\"label label-success\">Afgehandeld</span>";
        } elseif ($reservering["status"] == 4) {
            $reservering["status"] = "<span class=\"label label-danger\">Geannuleerd</span>";
        }
        
        print("<td class=\"reservering\">" . $reservering["status"] . "</td>");
        print("<td class=\"reservering\">
                    <div class=\"btn-group\">
...
function algemeneInstellingen() {
    ?>
        <form role="form" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-horizontal" method="post" action="instellingen.php">
            <div class="balk"><b>&nbsp Algemene instellingen</b></div>
            <fieldset>
                <!-- Text input-->
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="textinput">Website titel</label>
                    <div class="col-sm-8">
                ...
                <!-- Text input-->
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="textinput">Email adres</label>
                    <div class="col-sm-8">
...
function voorraadBeheer() {
    ?>
            <div class="balk"><b>&nbsp Voorraad Beheer</b></div>

            <fieldset>
                <!-- Text input-->
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="textinput">Default</label>
                    <div class="col-sm-8">
                ...
                <!-- Text input-->
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="textinput">On Hold</label>
                    <div class="col-sm-8">
...
function prijsBeheer() {
    ?>
            <div class="balk"><b>&nbsp Prijs instellingen</b></div>
            <p class="instellingenUitleg"> De prijs van een bestelling wordt aan de hand van de volgende formule berekend: dagprijs = aantal pistolen x prijs per pistool + startprijs.
                <br><br>Indien er sprake is van een weekend/week tarief, wordt daar nog een factor overheen berekend: weekendprijs = dagprijs x weekend factor OF weekprijs = dagprijs x week factor.</p>
            ...
            <fieldset>
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="textinput">Prijs per pistool</label>
                    <div class="col-sm-8">
                ...
                <!-- Text input-->
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="textinput">Weekend Factor</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="textinput">Week Factor</label>
                    <div class="col-sm-8">
...
//        }
    ...
    ?>
            <div class="balk"><b>&nbsp Beheer Google</b></div>

            <fieldset>
                <!-- Text input-->
                <div class="row form-group">
                    <label class="col-sm-3 col-xs-11 control-label" for="textinput">Tracking code</label>
                    <div class="col-sm-8">
    ...
    function checkAllFields() {
        ...
        $_SESSION['insMessage'] = "<div class=\"alert alert-danger\" id=\"success-alert\">
            ...
            return FALSE;
                ...
                $_SESSION['insOpslaan'] = TRUE;
                $_SESSION['insMessage'] = "<div class=\"col-xs-10 col-xs-offset-1 alert alert-danger\" id=\"success-alert\">
                            <button type=\"button\" class=\"close\" data-dismiss=\"alert\">x</button>
