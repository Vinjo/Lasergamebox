                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            if (empty($_POST['email'])) {
                                ...
                                if (filter_var($_POST['email'], FILTER_VALIDATE_EMAIL) == FALSE) {
                                    ...
                                    $websitelink = rtrim("http://project.stomic.com/admin/wachtwoord_vergeten.php?restorecode=", "/");
                                    $restorecodelink = "<a href='$websitelink" . $restorecode . "'>Wachtwoord herstellen</a>";
